...
describe("CToken", function () {
  ...
  describe("supplyRatePerBlock", () => {
    ...
    it("has a supply rate", async () => {
      ...
      const perBlock = await call(cToken, "supplyRatePerBlock");
      expect(
        Math.abs(perBlock * 2628000 - expectedSuplyRate * 1e18)
